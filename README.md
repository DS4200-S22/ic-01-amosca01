...
1. Add the link to your GitHub Page **BLAH**. 
...
After cloning a repository, you can get an updated version of the code stored in the cloud with [git pull](https://www.freecodecamp.org/news/git-pull-explained/). 
